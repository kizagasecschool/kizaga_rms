  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {[
          { label: 'Overall Performance', value: '--', color: 'bg-indigo-50 text-indigo-600' },
          { label: 'Pass Rate', value: '--', color: 'bg-emerald-50 text-emerald-600' },
          { label: 'Total Students', value: '--', color: 'bg-amber-50 text-amber-600' },
          { label: 'Exams Conducted', value: '--', color: 'bg-rose-50 text-rose-600' },
        ].map((stat) => (
