    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-lg w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <div className="flex items-center gap-2 bg-maroon-50 rounded-xl px-4 py-3 mb-2">
            <span className="text-3xl font-bold text-maroon-700 tracking-wider flex-1 text-center">{submitted}</span>
            <button
              onClick={() => handleCopy(submitted)}
              className="shrink-0 p-2 rounded-lg hover:bg-maroon-100 text-maroon-600 transition"
              title="Nakili namba"
            >
              {copied ? (
          ...
          {copied && <p className="text-xs text-green-600 mb-2">Imenakiliwa!</p>}
