  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {[
          { label: 'Total Students', value: '--', color: 'bg-indigo-50 text-indigo-600' },
          { label: 'Teachers', value: '--', color: 'bg-emerald-50 text-emerald-600' },
          { label: 'Classes', value: '--', color: 'bg-amber-50 text-amber-600' },
      ...
      <div className="mt-8 bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {[
            'Manage Users', 'Add Student', 'Create Class', 'Add Subject', 'Schedule Exam', 'View Reports'
          ].map((action) => (
            <button
              key={action}
