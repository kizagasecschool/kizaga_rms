-- Fix compute_student_result to check exam.has_practical before using 150 max
-- A subject may have has_practical=true but the exam may not include practicals.
-- In that case, max should be 100 (not 150).
